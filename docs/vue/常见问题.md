...
![](https://user-gold-cdn.xitu.io/2019/4/14/16a1c14ef315c9ed?w=341&h=33&f=png&s=11022)
...
![](https://user-gold-cdn.xitu.io/2019/4/14/16a1c0fbaba3cb39?w=937&h=399&f=png&s=60759)
...
![](https://user-gold-cdn.xitu.io/2019/4/14/16a1c2299f25fc31?w=728&h=139&f=png&s=56091)
...
![](https://user-gold-cdn.xitu.io/2019/4/15/16a1fc4b6bb38e74?w=803&h=255&f=png&s=53303)
...
![](https://user-gold-cdn.xitu.io/2019/4/15/16a1fc0eaed33cb1?w=782&h=235&f=png&s=52866)
...
![](https://user-gold-cdn.xitu.io/2019/4/22/16a44a70c67ea64f?w=1872&h=350&f=png&s=77152)

### 对象的 v-for

```vue
<template>
	<div v-for="(item, key) in json">{{item}}{{key}}</div>
</template>
```
...
![image-20190529101208581](http://ww2.sinaimg.cn/large/006tNc79gy1g3hyulqxdfj30eg06pjsi.jpg)
...
1. require 动态加载图片
2. static / public/ assets 目录的打包策略
